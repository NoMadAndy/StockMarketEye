...
def index():
    ...
    if form.validate_on_submit():
        ...
        # Neue Vorhersagen für die letzten 90 Tage des Testdatensatzes
        ...
        # Anhängen der neuen Vorhersagen
        ...
        plt.plot(np.arange(len(original_data), len(original_data) + len(new_predictions)), new_predictions, label='Future Predictions', linestyle='--')
        plt.legend()
